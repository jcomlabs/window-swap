...
description: >
  ...
  accent, the three-step gray text ladder, Arial (display/numerals/chrome) + Arial (body),
...
colors:
  ...
  text-muted: "#864eeb"
  text-light: "#9A9A9A"
  accent-light: "rgba(39, 103, 203, 0.08)"
  accent-medium: "rgba(39, 103, 203, 0.15)"
  border: "rgba(39, 103, 203, 0.2)"
  card-bg: "rgba(39, 103, 203, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Arial body + Arial chrome) —
  body:    { fontFamily: "Arial", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Arial", cqw: 0.8, weight: 700, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Arial", px: 12, weight: 400, color: "primary" }
  counter: { fontFamily: "Arial", px: 13, weight: 400, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Arial, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Arial", cqw: 1.25, weight: 400, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Arial", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Arial", cqw: 2.4, weight: 400, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Arial", cqw: 2.6, weight: 700, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Arial", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Arial", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Arial", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Arial** (display) / **Consolas** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Arial** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Arial** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Arial** (display/numerals/chrome) + **Arial** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Arial body 0.85cqw muted; Arial eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Arial `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Arial 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Arial `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Arial label + muted desc + optional
...
blockquote, cite. **Focal** a Arial `blockquote` near-black under a 15%-opacity cobalt
...
Arial body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Arial `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Arial 400 muted, line 1.6.
...
- **Type** — Arial headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Arial body muted line 1.6; ≥1.4cqw floor.
...
- **Arial + Arial via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
